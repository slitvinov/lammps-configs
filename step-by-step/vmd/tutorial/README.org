...
** label
Return list of the label categories
#+BEGIN_SRC tcl :noweb yes
return [label list]
#+END_SRC
...
Return all labels in every category
#+BEGIN_SRC tcl :noweb yes
set clst [label list]
set otp ""
foreach cname ${clst} {
    append otp "${cname}: [label list ${cname}] \n"
}
return ${otp}
#+END_SRC
...
Add and show label on atom
#+BEGIN_SRC tcl :noweb yes :results silent
<<sel>>
label add Atoms 0/4
#label textformat Atoms 4 Center
<<showpolymer>>
renderpng withlabel
#+END_SRC
...
#+BEGIN_SRC tcl :noweb yes
<<sel>>
return [molinfo top get numatoms]
#+END_SRC
...
<<sel>>
set out ""
append  out [molinfo top get {filename filetype center}] "\n"
append  out "numframes: " [molinfo top get numframes] "\n"
append  out "timesteps: " [molinfo top get timesteps]
return $out
#+END_SRC

#+RESULTS:
: {data.psf data.dcd} {psf dcd} {10.141185 10.121674 14.460485}
: numframes: 1
: timesteps: 0
